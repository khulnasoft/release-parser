...
# This is the content for the website homepage (https://releaselog.netlify.app/)
---
...
release-parser documents EOL dates and support lifecycles for various products.

release-parser aggregates data from various sources and presents it in an understandable and
succinct manner. It also makes the data available using an [easily accessible API](https://releaselog.netlify.app/docs/api)
and has iCalendar support.

release-parser currently tracks {{ site.pages | where: "layout", "product" | size }} products.
...
[new product suggestion or addition](https://github.com/khulnasoft/release-parser/issues/new?assignees=&labels=request&template=new_product_suggestion.md&title=),
[existing product updates](https://github.com/khulnasoft/release-parser/issues/new?assignees=&labels=bug&template=report_incorrect_details.md&title=),
[feature request](https://github.com/khulnasoft/release-parser/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=),
bug reports, fixes... Take a look at [our contribution guide](https://github.com/khulnasoft/release-parser/blob/master/CONTRIBUTING.md)
...
And do not hesitate to [play with our API](https://releaselog.netlify.app/docs/api). Here are a few awesome
...
[our Known Users page](https://github.com/khulnasoft/release-parser/wiki/Known-Users).
...
[![](https://img.shields.io/badge/Hacktoberfest-Welcome-green)](https://github.com/khulnasoft/release-parser/issues/408)
[![Gitter](https://img.shields.io/badge/chat%20on-gitter-green)](https://gitter.im/khulnasoft/community)
