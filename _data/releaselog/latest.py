...
As per data from _data/releaselog. This script runs on dependabot upgrade PRs via GitHub Actions for
_data/releaselog and commits back the updated data.
...
if __name__ == "__main__":
    ...
    # Example of dumping with aliases: https://github.com/khulnasoft/release-parser/pull/4368.
