...
- Automation scripts that updates latest releases are in the `_auto` directory. Also see the [`release-data`](https://github.com/khulnasoft/release-data/) repository, where the updates are fetched, and the [Automation](https://github.com/khulnasoft/release-parser/wiki/Automation) page on the wiki.
