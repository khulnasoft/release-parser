...
nav_exclude: true
title: Contributing
description: Some information on how to contribute to https://releaselog.netlify.app.
...
This project is participating in Hacktoberfest 2022. If you are looking to contribute, please check out our [detailed guide for hacktoberfest participants](https://github.com/khulnasoft/release-parser/issues/408).

## 🕐 What's this project?

Before you get started, get to know the project a little bit. Open [release-parser](https://releaselog.netlify.app) and browse around a little bit. Take a look at some of these recently merged PRs to get a better idea: [#1598](https://github.com/khulnasoft/release-parser/pull/1598), [#1603](https://github.com/khulnasoft/release-parser/pull/1603), [#1552](https://github.com/khulnasoft/release-parser/pull/1552), [#1596](https://github.com/khulnasoft/release-parser/pull/1596).

## :pencil: About the codebase

release-parser is built using [Jekyll](https://jekyllrb.com/) - the Ruby static site builder that powers GitHub Pages. The site is built and deployed to [Netlify](https://www.netlify.com/). Since the site is mostly informational, you _don't need programming skills to contribute to the project_.

## :new: Adding a new product

To add a new page to the website, [create a new markdown file with YAML frontmatter](https://github.com/khulnasoft/release-parser/new/master/products). Keep the filename as `productname.md`, and please delete any generic comments or unneeded keys before creating a Pull Request. Use the timezone from the upstream product for all dates, wherever possible.
...
# and use one of the tags listed on https://releaselog.netlify.app/tags/.
#
...
# Note that the use of a table include (see https://github.com/khulnasoft/release-parser/blob/master/products/ansible.md)
...
customColumns:
  ...
  - property: supportedIosVersions
    ...
    #   number (such as the OpenJDK version for https://releaselog.netlify.app/azul-zulu).
...
# Please visit https://github.com/khulnasoft/release-parser/wiki/Automation for more details.
...
auto:
  ...
  methods:
    ...
    - distrowatch: debian
      ...
      # A liquid template using the captured variables from the regex above that renders the final version
      # (optional, default can be found on https://github.com/khulnasoft/release-data/blob/main/src/distrowatch.py#L13 ).
      # You can use liquid templating here.
      template: '{{version}}'
...
# Please see https://releaselog.netlify.app/help/identifiers-needed/ for more information
identifiers:
...
#
# See also the Guiding Principles on the wiki ( https://github.com/khulnasoft/release-parser/wiki/Guiding-Principles )
...
For the product text, please make sure you read the [Guiding Principles](https://github.com/khulnasoft/release-parser/wiki/Guiding-Principles) for the website to match the tone. File a Pull Request with this file created, and Netlify will provide a preview URL for the same. Once the pull request is merged, the changes are automatically deployed on the website. See below for how to validate your changes.

You can visit <https://github.com/khulnasoft/release-parser/new/master/products> to directly create your file.
...
You may want to read the [HACKING documentation](https://github.com/khulnasoft/release-parser/blob/master/HACKING.md).
...
- [HACKING.md](https://github.com/khulnasoft/release-parser/blob/master/HACKING.md) contains instructions on setting up the codebase locally with Jekyll. Read this if you're planning to make complex changes or setting up the project locally.
- [Guiding Principles](https://github.com/khulnasoft/release-parser/wiki/Guiding-Principles) - These help us make decisions around the content we have. If you'd like to make sure your PR gets speedy approval, please read these to ensure your changes are aligned with the rest of the content. This is _especially important if you are making non-trivial changes_ that deal with the content or add a new product.
- [CONTRIBUTING.md](https://github.com/khulnasoft/release-parser/blob/master/CONTRIBUTING.md) - (This page). Also accessible at https://releaselog.netlify.app/contribute

## :bookmark: Code of Conduct

Please note that this project is released with a [Contributor Code of Conduct](https://github.com/khulnasoft/release-parser/blob/master/CODE-OF-CONDUCT.md).
